"""Serialize complete private engine states for deterministic fingerprints.

The canonical form identifies states inside engine transitions and policy-turn
bridges. It contains hidden game data and must never become a public response.
"""
