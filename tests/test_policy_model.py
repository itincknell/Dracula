...
from dracula.decision.action_mask import build_representative_action_mask
...
from dracula.decision.bridge import move_for_action_index
...
def test_model_initialization_is_deterministic_and_has_no_slot_embeddings() -> None:
    first = PolicyModel(202)
    second = PolicyModel(202)
    assert all(
